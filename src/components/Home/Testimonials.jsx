...
const TestimonialSlider = () => {
  ...
  return (
    <div className="w-full h-[90vh] lg:p-20 p-2 py-4">
      <h2 className="text-lg uppercase mb-2 text-center text-secondary text-[24px] font-[700]">
        Our clients say
      </h2>
      <h1 className="text-4xl text-center mb-4 font-[700] text-10 md:text-[60px] text-white">
        Testimonials
      </h1>
      <div className="relative flex justify-center items-center bg-cover bg-center h-full md:h-[70vh] w-full overflow-hidden">
        <div
        ...
        >
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="z-10 text-center text-white p-10 md:w-[70%] w-[90%] h-[80%]  border-[10px] border-secondary bg-opacity-50  relative">
               <div className="text-center flex flex-col justify-between h-full w-full md:p-10 ">
               <div>
                ...
                <button
                  className="text-black hidden md:block hover:text-yellow-500 absolute -left-32 top-[50%] -translate-y-[50%] bg-secondary p-3"
                  onClick={goToPrevious}
                >
                  <FaAngleLeft className="text-2xl" />
                </button>
                <button
                  className="text-black hidden md:block hover:text-yellow-500 absolute -right-32 top-[50%] -translate-y-[50%] bg-secondary p-3"
                  onClick={goToNext}
                >
